...
class ets:
    def __init__(self, df, max_date = pd.Timestamp.today(), elitism=1, optimizer="genetic hybrid", size=2):
...
#                                             alpha         beta            initial_level   initial_trend  phi/gamma   s_list       fitness fxn             mutation          simple crossover          crossover function
        template1 = genetic.Genetic_Template([alpha_bounds,                 level_bounds],                                          self.fitness_aia,       mutation = False, simple_crossover = False, crossover_function=float_crossover)
        template2 = genetic.Genetic_Template([alpha_bounds, param_bounds,   level_bounds,   trend_bounds],                          self.fitness_abiaib,    mutation = False, simple_crossover = False, crossover_function=float_crossover)
        template3 = genetic.Genetic_Template([alpha_bounds, param_bounds,   level_bounds,   trend_bounds, param_bounds],            self.fitness_abiaibd,   mutation = False, simple_crossover = False, crossover_function=float_crossover)
        template4 = genetic.Genetic_Template([alpha_bounds, param_bounds,   level_bounds_m, trend_bounds_m],                        self.fitness_abiaib_m,  mutation = False, simple_crossover = False, crossover_function=float_crossover)
        # template5 = genetic.Genetic_Template([alpha_bounds, param_bounds,   level_bounds,   trend_bounds, param_bounds, *s_list],   self.fitness_abiaibgs,  mutation = False, simple_crossover = False, crossover_function=float_crossover)
